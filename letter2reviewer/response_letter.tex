...
\textbf{Rewrite this section to be more specific to the paper and the comments received.}
...
\begin{reply}
   ...
   We have added more details in the revised manuscript, including the lambda spacing, soft-core potential parameters, and the fact that we are using independent lambda values for our free energy calculations.
