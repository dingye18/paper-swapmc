...
Recent advances in force field development, including OPLS4~\cite{lu2021opls4}, CGenFF~\cite{vanommeslaeghe2012automationI, vanommeslaeghe2012automationII}, GAFF2~\cite{he2022recent}, and OpenFF~\cite{wang2024open,Boothroyd2023}, have substantially improved molecular representation accuracy, 
...
\begin{table}
  ...
  \begin{tabular}{l|lllll}
    ...
    $\Delta \Delta G$ RMSE ($R^2$)          & No SwapMC  & With SwapMC   & No SwapMC   & With SwapMC  & Gregory et al.~\cite{ross2020enhancing} \\
    \hline
...
Concurrent $R^2$ improvements for these systems (CDK2: 0.09 $\to$ 0.55, TYK2: 0.40 $\to$ 0.47) indicate that SwapMC not only reduced absolute errors but also improved rank-ordering correlation with experimental data, suggesting more reliable discrimination of binding affinity differences. 
