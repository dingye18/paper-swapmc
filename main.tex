...
the incresement of contact waters is consistent with the transformation of Ligand 9 to Ligand 7 with larger open space in cavity of the protein pocket. 
...
The aggregate mean RMSE decreased from 3.69 $\pm$ 2.54 kcal/mol (no SwapMC) to 3.14 $\pm$ 1.54 kcal/mol (with SwapMC), a 0.55 kcal/mol mean reduction. 
